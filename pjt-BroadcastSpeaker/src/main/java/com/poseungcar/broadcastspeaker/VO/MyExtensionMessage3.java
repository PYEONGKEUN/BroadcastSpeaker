...
public class MyExtensionMessage3 {
	...
	public MyExtensionMessage3(String INTENT_NAME, String message, boolean session, String type)
	{ 
		// MyResponseValue 객체 
